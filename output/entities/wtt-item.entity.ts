...
@Index("pk_wttitem_id", ["id"], { unique: true })
@Index("fk_wttitem_wtspostid", ["wtsPostId"], {})
@Entity("wtt_item", { schema: "public" })
export class WttItem {
  ...
  @ManyToOne(() => WtsPost, (wtsPost) => wtsPost.wttItems, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
  ...
  @OneToMany(() => WttOptionGroup, (wttOptionGroup) => wttOptionGroup.wttItem)
